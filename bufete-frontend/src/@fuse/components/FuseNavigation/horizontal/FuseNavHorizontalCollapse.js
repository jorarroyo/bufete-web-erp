                        ...
                        <ul className={clsx(classes.children, 'pl-0')}>
                          {item.children.map(item => (
                            <React.Fragment key={item.id}>
                              {item.type === 'group' && <FuseNavHorizontalGroup item={item} nestedLevel={nestedLevel + 1} dense={dense} />}

                              {item.type === 'collapse' && <NavHorizontalCollapse item={item} nestedLevel={nestedLevel + 1} dense={dense} />}

                              {item.type === 'item' && <FuseNavHorizontalItem item={item} nestedLevel={nestedLevel + 1} dense={dense} />}

                              {item.type === 'link' && <FuseNavHorizontalLink item={item} nestedLevel={nestedLevel + 1} dense={dense} />}
                            </React.Fragment>
                          ))}
                        </ul>
                      )}
