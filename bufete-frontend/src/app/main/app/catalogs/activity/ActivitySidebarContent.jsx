...
const ActivitySidebarContent = props => {
        ...
        <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
          ...
          <List>
            <ListItem
              ...
              to="/apps/catalogs/activities/list/active"
            ...
            <ListItem button component={NavLinkAdapter} to="/apps/catalogs/activities/list/all" activeClassName="active" className={classes.listItem}>
              <Icon className="list-item-icon text-16" color="action">
                assignment_late
              </Icon>
              <ListItemText className="truncate pr-0" primary="Todas las Actividades" disableTypography />
            </ListItem>
          </List>
        </Paper>
      </FuseAnimate>
