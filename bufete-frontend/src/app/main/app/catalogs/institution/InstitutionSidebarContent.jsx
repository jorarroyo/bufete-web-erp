...
const InstitutionSidebarContent = props => {
        ...
        <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
          ...
          <List>
            <ListItem
              ...
              to="/apps/catalogs/institutions/list/active"
            ...
            <ListItem
              button
              component={NavLinkAdapter}
              to="/apps/catalogs/institutions/list/all"
              activeClassName="active"
              className={classes.listItem}
            >
              <Icon className="list-item-icon text-16" color="action">
              ...
              <ListItemText className="truncate pr-0" primary="Todas las Instituciones" disableTypography />
            </ListItem>
          </List>
        </Paper>
      </FuseAnimate>
...
export default InstitutionSidebarContent;
