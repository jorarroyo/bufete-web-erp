  ...
  return (
    <div className="flex flex-1 w-full items-center justify-between">
          ...
          <FuseAnimate animation="transition.slideDownIn" delay={300}>
            <Paper className="flex items-center w-full max-w-512 px-8 py-4 rounded-8" elevation={1}>
              ...
              <Input
                ...
                onChange={ev => dispatch(Actions.setPaymentReceiptSearchText(ev))}
              />
            </Paper>
          </FuseAnimate>
        </ThemeProvider>
      ...
      <FuseAnimate animation="transition.slideRightIn" delay={300}>
        <Button component={Link} to="/apps/account-receivable/payment-receipts/new" className="whitespace-no-wrap" variant="contained">
          <span className="hidden sm:flex">Nuevo Pago de Factura</span>
