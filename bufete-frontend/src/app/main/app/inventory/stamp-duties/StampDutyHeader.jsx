  ...
  return (
    <div className="flex flex-1 w-full items-center justify-between">
          ...
          <FuseAnimate animation="transition.slideDownIn" delay={300}>
            <Paper className="flex items-center w-full max-w-512 px-8 py-4 rounded-8" elevation={1}>
              ...
              <Input
                ...
                onChange={ev => dispatch(Actions.setStampDutySearchCriteria(ev))}
              />
            </Paper>
          </FuseAnimate>
        </ThemeProvider>
      ...
      <FuseAnimate animation="transition.slideRightIn" delay={300}>
        <Button component={Link} onClick={() => dispatch(Actions.openAddStampDutyDialog())} className="whitespace-no-wrap" variant="contained">
          <span className="hidden sm:flex">Nueva Entrada</span>
