...
public class ActivitySettleListResponse implements Serializable {
  ...
  private List<ActivitySettleDetailResponse> activityList;

  public ActivitySettleListResponse(Long id, String comments, String invoiceNum, String invoiceRange,
      String invoiceName, String invoiceDescription, Double invoiceTotal, StatusName status, Date assignDate,
      Long proctorAgendaId, List<ActivitySettleDetailResponse> activityList) {
    this.id = id;
  ...
  public ActivitySettleListResponse() {
  }
  ...
  public List<ActivitySettleDetailResponse> getActivityList() {
    return activityList;
  }

  public void setActivityList(List<ActivitySettleDetailResponse> activityList) {
    this.activityList = activityList;
  }
