...
public class ProctorAgendaRequest implements Serializable {
  ...
  private List<ProctorAgendaActivityRequest> activityList;

  public ProctorAgendaRequest(Long id, Long employeeId, String comment, StatusName status, Double proctorAgendaCostLocal, Double proctorAgendaCostOuter,
  Double agendaReturnAmountLocal, Double agendaReturnAmountOuter, List<ProctorAgendaActivityRequest> activityList) {
    this.id = id;
  ...
  public List<ProctorAgendaActivityRequest> getActivityList() {
    return activityList;
  }

  public void setActivityList(List<ProctorAgendaActivityRequest> activityList) {
    this.activityList = activityList;
  }
